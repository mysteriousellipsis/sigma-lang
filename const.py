...
"""
contains static values that are referenced by the program_re
allows for easy renaming of values
"""
...
KEYWORDS: Dict[str, Union[str, Dict[str, str], Set[str]]] = {
    ...
    "LESS": "is less than",
    "LOGICAL_OPERATORS": {"LOGICAL_AND": "and", "LOGICAL_OR": "or", "NOT": "is not"},
    # flow control
    "BREAK": "break",
    "CONTINUE": "continue",
    # "PASS": "pass",
